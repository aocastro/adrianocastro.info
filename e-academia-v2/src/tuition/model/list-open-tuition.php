<?php
    ...
    $sql = "SELECT s.nameStudents, t.idTuition, DATE_FORMAT(t.dueDate, '%d/%m/%Y') as vencimento, t.grossValue FROM AGUAVIVA_STUDENTS s, AGUAVIVA_TUITION t WHERE s.idStudents = t.AGUAVIVA_STUDENTS_idStudents AND t.statusPayment = 1 AND dueDate <= NOW() AND 1=1 ";
