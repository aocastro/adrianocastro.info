$(document).ready(function() {
    ...
    $('#table-payment').on('click', 'button.btn-view', function(e) {
        ...
        $('.modal-title').append('<h4 class="text-danger">Visualizar forma de pagamento</h4>')
            ...
            success: function(dado) {
                if (dado.tipo == "success") {
                    $('.modal-body').load('src/payment/view/form-payment.html', function() {
                        ...
                        $('#namePayment').attr('readonly', 'true')
                    })
