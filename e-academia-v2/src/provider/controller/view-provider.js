$(document).ready(function() {
    ...
    $('#table-provider').on('click', 'button.btn-view', function(e) {
        ...
        $('.modal-title').append('<h4 class="text-danger">Visualizar forncedor</h4>')
