    ...
    class Message extends Sql{
        ...
        public function insert()
        {
            ...
            try {
                ...
                $stm->bind_param('ssisi', $this->title, $this->text, $this->status, $this->type, $this->user_id);
        ...
        public function edit()
        {
            ...
            try {
                ...
                $sql = "UPDATE `PANEL_MESSAGE` SET `dateMessage` = (SELECT CURRENT_DATE()), `titleMessage` = ?, `textMessage` = ?, `statusMessage` = ?, `typeMessage` = ?, `users_idUsers` = ? WHERE `idMessage` = ?";

                $stm = $db->getConn()->prepare($sql);

                $stm->bind_param('ssisii', $this->title, $this->text, $this->status, $this->type, $this->user_id, $this->id);
            ...
            try {
                ...
                if ($rs = $db->getConn()->query($sql)) {
                    ...
                    while ($resultado = mysqli_fetch_object($rs)) {
                        ...
                        $data["user_id"] = $resultado->user_idUser;
            ...
            try {
                ...
                if ($rs = $db->getConn()->query($sql)) {
                    ...
                    while ($resultado = mysqli_fetch_object($rs)) {
                        ...
                        $message["user_id"] = $resultado->user_idUser;
